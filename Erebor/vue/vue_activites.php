...
<?php
				...
				{			
					...
					echo "<a href='index.php?section=reglementactivite&IdAct=$wIdActivite'>
							<div id='blockactivite'>
									<img class='imgactivite' src='$wImgActivite'>
									<div id='texteactivite'>L'activité $wNomActivite</div></br>
									<div id='btnchambre'><a href='index.php?section=reglementactivite&IdAct=$wIdActivite'>En savoir plus</a></div>

...
<div id="volet_clos">
    ...
    <!--bouton fermer volet-->
    	<a href="#?" class="fermer" aria-hidden="true">
			<img src="/Erebor/vue/image/data/close-black.svg" alt="fermer" style="width: 1em;">
		</a>
	<!--nom du site-->	
		<p id="title-volet">
...
<div id="lieu_clos">
    <div id="lieu" style="overflow-y: auto; overflow-x: hidden;">
    <!--bouton fermer volet-->
    	<a href="#??" class="fermer" aria-hidden="true">
			<img src="/Erebor/vue/image/data/close-black.svg" alt="fermer" style="width: 1em;">
		</a>
	<!--nom du site-->	
		<p id="titre-volet-lieu">
			<a href="" rel="home" style="color:black;">Coin tourisme</a>
		</p>                   
			<?php
				//affichage des lieux à visiter
				foreach($leslieux as $unLieu)
				{	
					$wIdLieu=$unLieu['IdLieu'];
					$wNomLieu=$unLieu['NomLieu'];
					$wImgLieu=$unLieu['ImgLieu'];
					$wUrlLieu=$unLieu['UrlLieu'];


					echo "
								<a target='_blank' href='$wUrlLieu'>
								<div class='blocklieu'>
									<img class='imglieu' src='/Erebor/vue/image/lieu/$wImgLieu'> 
											<div id='lieutexte'> $wNomLieu 
												<div id='btn-visite-lieu'></div>
											</div>
									</div>
								</a>"; // on affiche l'image du lieu à visiter			
				}
			?>	
	...
	<div id="contact_clos">
    <div id="contact" style="overflow-y: auto; overflow-x: hidden;">
    <!--bouton fermer volet-->
    	<a href="#??" class="fermer" aria-hidden="true">
			<img src="/Erebor/vue/image/data/close-black.svg" alt="fermer" style="width: 1em;">
		</a>
	<!--nom du site-->	
		<p id="title-contact">
			<a href="" rel="home" style="color:black;">Contact</a>
		</p>
	<!--menu de navigation-->
		<div class="main-navigation">
				<center> Notre adresse </center>
              <center> 22 rue de l'anneau, La Richardais, 35780 </center>
               <a href="mailto:tommyguy65@gmail.com"><div id="btn-contact"> gite-erebor@orange.fr </div> </a>
              <a href="tel:0672438940"><div id="btn-contact">06 72 43 89 40 </div></a> <!-- fonction d'envoi vers un téléphone portable -->
		</div>
			<!--juridique-->
			<p id="copyright">
				©2016 Erebor.
...
function mois_suivant(){
    //On rꤵp鳥 le mois actuel puis on v곩fie que l'on est pas en janvier sinon on ajoute une annꥍ
    if(current_month == 12){
        current_month = 1;
        current_year = current_year  + 1;
    }
